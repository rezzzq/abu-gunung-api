...
const id = {
  appTitle: "Sebaran Abu Krakatau",
  subtitle: "Peta langsung abu vulkanik Anak Krakatau",
  updated: "Diperbarui {rel}",
  noAdvisory: "Saat ini tidak ada peringatan sebaran abu yang aktif untuk Anak Krakatau.",
  ...
  distanceFrom: "Anda sekitar {km} km dari kawah.",
  ...
  shareText: "Peta langsung sebaran abu Anak Krakatau, diperbarui otomatis.",
  copied: "Tautan disalin",
  madeBy: "Dibuat sukarela oleh",
  madeByTail: "Gratis, tanpa iklan.",
  dataFrom: "Data: VAAC Darwin, PVMBG/MAGMA Indonesia, NASA GIBS (Himawari-9), Open-Meteo.",
  satellite: "Citra satelit inframerah",
...
const en: Record<StringKey, string> = {
  appTitle: "Krakatau Ash Map",
  subtitle: "Live volcanic ash map for Anak Krakatau",
  updated: "Updated {rel}",
  noAdvisory: "There is no active ash advisory for Anak Krakatau right now.",
  ...
  distanceFrom: "You are about {km} km from the crater.",
  ...
  shareText: "Live map of Anak Krakatau ash coverage, updated automatically.",
  copied: "Link copied",
  madeBy: "Made as a volunteer effort by",
  madeByTail: "Free, no ads.",
  dataFrom: "Data: VAAC Darwin, PVMBG/MAGMA Indonesia, NASA GIBS (Himawari-9), Open-Meteo.",
  satellite: "Infrared satellite image",
