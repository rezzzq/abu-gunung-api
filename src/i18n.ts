...
const id = {
  ...
  airports: "Bandara terdekat",
  airportsHint: "Laporan cuaca bandara (METAR). Status buka atau tutup resmi ada di NOTAM, bukan di sini.",
  airportsHintNotam: "Status tutup dari NOTAM resmi; cuaca dari laporan METAR bandara.",
  airportClosed: "Ditutup",
  airportClosedUntil: "Ditutup s.d. {time} WIB",
  airportOpen: "NOTAM: tidak ada penutupan",
  airportAshNotam: "NOTAM abu berlaku",
  airportAsh: "Abu dilaporkan",
  airportClear: "Tidak ada abu",
  airportNoReport: "Tidak ada laporan",
  airportVisibility: "jarak pandang {km} km",
  airportAt: "{time} WIB",
  airportDistance: "{km} km",
  ...
  satelliteTrue: "Citra satelit: warna asli (siang)",
  tagTrue: "Warna asli",
  menuOff: "Tanpa citra satelit",
  menuTrue: "Warna asli (siang)",
  menuRgb: "RGB abu",
  menuSignal: "Sinyal abu (eksperimental)",
  menuIr: "Inframerah",
  hintNight: "hanya siang hari",
  hintUnavailable: "belum tersedia",
  trueLegend: "Warna asli Himawari-9: abu tampak cokelat, bayangannya gelap",
...
const en: Record<StringKey, string> = {
  ...
  airportsHint: "Airport weather reports (METAR). Official open or closed status comes from NOTAMs, not from here.",
  airportsHintNotam: "Closed status from official NOTAMs; weather from the airport METAR reports.",
  airportClosed: "Closed",
  airportClosedUntil: "Closed until {time} WIB",
  airportOpen: "NOTAM: no closure",
  airportAshNotam: "Ash NOTAM in force",
  airportAsh: "Ash reported",
  airportClear: "No ash",
  airportNoReport: "No report",
  airportVisibility: "visibility {km} km",
  airportAt: "{time} WIB",
  airportDistance: "{km} km",
  ...
  satelliteTrue: "Satellite imagery: true colour (daytime)",
  tagTrue: "True colour",
  menuOff: "No satellite imagery",
  menuTrue: "True colour (daytime)",
  menuRgb: "Ash RGB",
  menuSignal: "Ash signal (experimental)",
  menuIr: "Infrared",
  hintNight: "daytime only",
  hintUnavailable: "not available yet",
  trueLegend: "Himawari-9 true colour: ash looks brown, its shadow dark",
