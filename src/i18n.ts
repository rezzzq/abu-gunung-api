...
const id = {
  ...
  airportSite: "Situs resmi",
  airportsOfficial: "Pengumuman resmi:",
  airportsOperator: "InJourney Airports",
  airportsDgca: "Ditjen Perhubungan Udara",
  airportsHintNotam: "Status tutup dari NOTAM resmi; cuaca dari laporan METAR bandara.",
  airportClosed: "Ditutup",
  airportClosedUntil: "Ditutup s.d. {time}",
  ...
  signalWeak: "lemah",
  signalStrong: "kuat",
  satelliteFrame: "Himawari-9, sekitar {time}",
  ...
  advEruption: "Letusan",
  advObserved: "Diamati {time}",
  advEstimated: "Diperkirakan {time}",
  advForecasts: "Perkiraan VAAC",
  advRemarks: "Catatan analis VAAC",
  advInfoSource: "Dasar pengamatan: {src}",
  advSource: "Diambil dari {src}",
  srcBom: "arsip resmi BoM (VAAC Darwin)",
  srcNoaa: "cermin NOAA",
  advOverdue: "Pembaruan VAAC terlambat {min} menit dari jadwal.",
  advHistory: "Riwayat peringatan ({n})",
  advRaw: "Teks asli VAAC (bahasa Inggris)",
  advGraphic: "Grafik resmi VAAC Darwin untuk peringatan ini",
  layerArea: "luas ± {km2} km²",
  layerReach: "terjauh {km} km dari kawah",
  layerSpeed: "{kmh} km/jam ({kt} kt)",
  noLayers: "tidak ada abu",
  flLabel: "FL{fl}",
...
const en: Record<StringKey, string> = {
  ...
  airportSite: "Official site",
  airportsOfficial: "Official announcements:",
  airportsOperator: "InJourney Airports",
  airportsDgca: "Directorate General of Civil Aviation",
  airportsHintNotam: "Closed status from official NOTAMs; weather from the airport METAR reports.",
  airportClosed: "Closed",
  airportClosedUntil: "Closed until {time}",
  ...
  signalWeak: "weak",
  signalStrong: "strong",
  satelliteFrame: "Himawari-9, about {time}",
  ...
  advEruption: "Eruption",
  advObserved: "Observed {time}",
  advEstimated: "Estimated {time}",
  advForecasts: "VAAC forecast",
  advRemarks: "VAAC analyst remarks",
  advInfoSource: "Basis of observation: {src}",
  advSource: "Taken from {src}",
  srcBom: "the BoM official archive (Darwin VAAC)",
  srcNoaa: "the NOAA mirror",
  advOverdue: "The VAAC update is {min} minutes past its schedule.",
  advHistory: "Advisory history ({n})",
  advRaw: "Original VAAC text",
  advGraphic: "Official Darwin VAAC graphic for this advisory",
  layerArea: "area about {km2} km²",
  layerReach: "farthest {km} km from the crater",
  layerSpeed: "{kmh} km/h ({kt} kt)",
  noLayers: "no ash",
  flLabel: "FL{fl}",
